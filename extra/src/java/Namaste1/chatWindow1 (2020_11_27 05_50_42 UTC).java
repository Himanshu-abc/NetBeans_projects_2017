 ...
 * @author Dell
 */
public class chatWindow1 extends HttpServlet {
        ...
        if(request.getParameter("txtMsg")!=null)
         {
           ...
           try
           {
                ...
                String sql = "insert into hello_message_s values ('"+username+"','"+message+"')";
         ...
         try
         {
            ...
            ResultSet rs=st.executeQuery("select *from hello_message_s");
