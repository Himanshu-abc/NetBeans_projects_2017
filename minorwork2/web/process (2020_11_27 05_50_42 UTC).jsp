<%-- 
    Document   : process
    Created on : 18 Apr, 2017, 12:14:08 PM
    Author     : Dell
--%>
...
ResultSet rs = st.executeQuery("select * from main where password= '"+ OldPassword + "' ");
if (rs.next()) { 
...
st = con.createStatement();
int i = st.executeUpdate("update main set password='"+ Newpass + "' where username='"+ username+"' ");
