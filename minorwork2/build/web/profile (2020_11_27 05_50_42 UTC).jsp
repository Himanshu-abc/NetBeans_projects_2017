<%-- 
    Document   : profile
    Created on : 18 Apr, 2017, 12:15:31 PM
    Author     : Dell
--%>
...
<html>
    ...
    <body>
        ...
        String path="C:/Users/Dell/Documents/NetBeansProjects/minorwork2/web/pic";
        %>
        <%
      ...
      out.println("Uploaded................!");
        ...
        %>
         <%
             try{
          String query="insert into main (ppic) values('"+ str +"')";
