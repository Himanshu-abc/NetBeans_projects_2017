<%-- 
    ...
    Created on : 14 May, 2017, 3:54:11 PM
    Author     : Dell
--%>
...
<html>
    ...
    <body>
        ...
        String path="C:/Users/Dell/Documents/NetBeansProjects/extrapic/web/images";
        %>
        <%
      ...
      out.println("Uploaded................!");
        ...
        %>
         <%
             try{
         String query="insert into minor_s pic values('"+ str +"')";
